...
use mlua::ffi::{
    ...
    lua_pushvalue, lua_setmetatable, lua_tolstring, lua_touserdata, luaL_Reg, luaL_checklstring,
    luaL_error,
};
...
use crate::common::tokenize::L_TK_PATTERN;
...
pub use self::gregex_h::{
    _GMatchInfo, _GRegex, G_REGEX_ANCHORED, G_REGEX_BSR_ANYCRLF, G_REGEX_CASELESS, G_REGEX_DEFAULT,
    ...
    G_REGEX_NO_AUTO_CAPTURE, G_REGEX_OPTIMIZE, G_REGEX_RAW, G_REGEX_UNGREEDY, GMatchInfo, GRegex,
    GRegexCompileFlags, GRegexMatchFlags, g_regex_match, g_regex_new, g_regex_unref,
};
#[derive(Copy, Clone)]
#[repr(C)]
pub struct lregex_t {
...
unsafe extern "C-unwind" fn regex_new(mut L: *mut lua_State) -> *mut lregex_t {
    let mut p: *mut lregex_t =
        lua_newuserdata(L, ::core::mem::size_of::<lregex_t>()) as *mut lregex_t;
    memset(
        p as *mut std::ffi::c_void,
        0 as std::ffi::c_int,
        (::core::mem::size_of::<lregex_t>()).wrapping_mul(1),
    );
...
unsafe extern "C-unwind" fn luaH_regex_gc(mut L: *mut lua_State) -> gint {
    let mut regex: *mut lregex_t =
        luaH_checkudata(L, 1 as std::ffi::c_int, &mut regex_class) as *mut lregex_t;
...
unsafe extern "C-unwind" fn luaH_regenerate_regex(mut L: *mut lua_State, mut regex: *mut lregex_t) {
...
unsafe extern "C-unwind" fn luaH_regex_new(mut L: *mut lua_State) -> std::ffi::c_int {
    ...
    let mut regex: *mut lregex_t = lua_touserdata(L, -(1 as std::ffi::c_int)) as *mut lregex_t;
    if ((*regex).pattern).is_null() {
        return luaL_error(
            L,
...
unsafe extern "C-unwind" fn luaH_regex_match(mut L: *mut lua_State) -> std::ffi::c_int {
    let mut regex: *mut lregex_t =
        luaH_checkudata(L, 1 as std::ffi::c_int, &mut regex_class) as *mut lregex_t;
    let mut haystack: *const gchar = luaL_checklstring(L, 2 as std::ffi::c_int, 0 as *mut size_t);
    if !((*regex).reg).is_null() {
    } else {
        g_assertion_message_expr(
            0 as *mut gchar,
            b"common/clib/regex.c\0" as *const u8 as *const std::ffi::c_char,
            88 as std::ffi::c_int,
            (*::core::mem::transmute::<&[u8; 17], &[std::ffi::c_char; 17]>(b"luaH_regex_match\0"))
                .as_ptr(),
...
unsafe extern "C-unwind" fn luaH_regex_set_pattern(
    ...
    let mut new_pattern: *mut gchar = g_strdup(luaL_checklstring(
        L,
        -(1 as std::ffi::c_int),
        0 as *mut size_t,
    ));
...
pub unsafe extern "C-unwind" fn regex_class_setup(mut L: *mut lua_State) {
        ...
        [
            {
                let mut init = luaL_Reg {
                    ...
                    func: luaH_regex_class_add_signal,
                };
                init
            },
            {
                let mut init = luaL_Reg {
                    ...
                    func: luaH_regex_class_remove_signal,
                };
                init
            },
            {
                let mut init = luaL_Reg {
                    ...
                    func: luaH_regex_class_emit_signal,
                };
                init
            },
            {
    ...
    luaH_class_setup(
        ...
        >(Some(
            regex_new as unsafe extern "C-unwind" fn(*mut lua_State) -> *mut lregex_t,
        )),
        None,
        None,
    ...
    luaH_class_add_property(
        ...
        L_TK_PATTERN,
        ::core::mem::transmute::<
            Option<unsafe extern "C-unwind" fn(*mut lua_State, *mut lregex_t) -> std::ffi::c_int>,
            lua_class_propfunc_t,
        >(Some(
            luaH_regex_set_pattern
                as unsafe extern "C-unwind" fn(*mut lua_State, *mut lregex_t) -> std::ffi::c_int,
        )),
        ::core::mem::transmute::<
            Option<unsafe extern "C-unwind" fn(*mut lua_State, *mut lregex_t) -> std::ffi::c_int>,
            lua_class_propfunc_t,

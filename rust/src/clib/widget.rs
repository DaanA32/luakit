...
pub mod widget_h {
    ...
    use crate::common::luaclass::{lua_class_t, luaH_checkudata};
    use crate::common::messages::G_LOG_DOMAIN;
...
pub use self::widget_h::{
    GOBJECT_LUAKIT_WIDGET_DATA_KEY, luaH_checkwidget, widget_box, widget_class,
    widget_constructor_t, widget_destructor_t, widget_drawing_area, widget_entry, widget_eventbox,
    widget_image, widget_info_t, widget_label, widget_notebook, widget_overlay, widget_paned,
    widget_scrolled, widget_spinner, widget_stack, widget_t, widget_webview, widget_window,
};

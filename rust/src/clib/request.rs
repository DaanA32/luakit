...
pub mod giotypes_h {
    ...
    use super::ginputstream_h::_GInputStream;
}
#[c2rust::header_src = "/usr/include/glib-2.0/gio/ginputstream.h:23"]
pub mod ginputstream_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "44:8"]
...
#[c2rust::header_src = "/usr/include/webkitgtk-4.1/webkit/WebKitURISchemeRequest.h:23"]
pub mod WebKitURISchemeRequest_h {
    ...
    use super::gobject_h::GObject;
    use super::giotypes_h::GInputStream;
...
pub mod gstrfuncs_h {
    use super::gtypes_h::{gconstpointer, gpointer};
    use super::glibconfig_h::gsize;
    extern "C" {
...
#[c2rust::header_src = "/home/daana/git/luakit/common/luauniq.h:22"]
pub mod luauniq_h {
    use super::lua_h::lua_State;
...
#[c2rust::header_src = "/usr/include/glib-2.0/gio/gmemoryinputstream.h:23"]
pub mod gmemoryinputstream_h {
    use super::glibconfig_h::gssize;
    use super::gtypes_h::GDestroyNotify;
    use super::giotypes_h::GInputStream;
    extern "C" {
        #[c2rust::src_loc = "69:1"]
...
pub use self::glibconfig_h::{guint32, gint64, gssize, gsize};
...
pub use self::gerror_h::{_GError, GError, g_error_new_literal};
...
pub use self::lua_h::{
    lua_CFunction, lua_State, lua_gettop, lua_pushvalue, lua_isstring, lua_type,
    lua_tolstring, lua_pushnil, lua_pushboolean, lua_createtable, lua_newuserdata,
...
pub use self::giotypes_h::GInputStream;
pub use self::ginputstream_h::{_GInputStream, GInputStreamPrivate, _GInputStreamPrivate};
pub use self::WebKitURISchemeRequest_h::{
    _WebKitURISchemeRequest, WebKitURISchemeRequestPrivate, WebKitURISchemeRequest,
    _WebKitURISchemeRequestPrivate, webkit_uri_scheme_request_finish,
    webkit_uri_scheme_request_finish_error,
};
use self::string_h::memset;
use self::gmem_h::g_free;
use self::gstrfuncs_h::g_memdup2;
...
use self::gmemoryinputstream_h::g_memory_input_stream_new_from_data;
#[derive(Copy, Clone)]
#[repr(C)]
#[c2rust::src_loc = "33:9"]
...
#[inline]
#[c2rust::src_loc = "40:1"]
unsafe extern "C" fn luaH_request_class_emit_signal(mut L: *mut lua_State) -> gint {
...
#[inline]
#[c2rust::src_loc = "40:1"]
unsafe extern "C" fn luaH_request_class_add_signal(mut L: *mut lua_State) -> gint {
...
#[inline]
#[c2rust::src_loc = "40:1"]
unsafe extern "C" fn luaH_request_class_remove_signal(mut L: *mut lua_State) -> gint {
...
#[inline]
#[c2rust::src_loc = "40:1"]
unsafe extern "C" fn request_new(mut L: *mut lua_State) -> *mut request_t {
    let mut p: *mut request_t = lua_newuserdata(
        L,
        ::core::mem::size_of::<request_t>() as std::ffi::c_ulong,
    ) as *mut request_t;
    memset(
...
#[c2rust::src_loc = "42:1"]
unsafe extern "C" fn luaH_check_request(
    mut L: *mut lua_State,
    mut idx: gint,
) -> *mut request_t {
    let mut request: *mut request_t = luaH_checkudata(L, idx, &mut request_class)
        as *mut request_t;
    if (*request).finished != 0 {
        luaL_error(
            L,
            b"request has already been finished\0" as *const u8
...
#[no_mangle]
#[c2rust::src_loc = "51:1"]
pub unsafe extern "C" fn luaH_request_push_uri_scheme_request(
    mut L: *mut lua_State,
    ...
    (*request).request = g_object_ref(r as gpointer) as *mut WebKitURISchemeRequest;
...
#[c2rust::src_loc = "66:1"]
unsafe extern "C" fn luaH_request_finish(mut L: *mut lua_State) -> gint {
    ...
    if lua_isstring(L, 2 as std::ffi::c_int) == 0 {
        ...
        {
            error_message = b"MIME type isn't a string or nil\0" as *const u8
                as *const std::ffi::c_char;
        } else {
            length = 0;
            data = lua_tolstring(L, 2 as std::ffi::c_int, &mut length);
            let ref mut fresh0 = lua_tolstring(
                L,
                3 as std::ffi::c_int,
                0 as *mut size_t,
            );
            ...
            stream = g_memory_input_stream_new_from_data(
                g_memdup2(data as gconstpointer, length) as *const std::ffi::c_void,
                length as gssize,
                Some(g_free as unsafe extern "C" fn(gpointer) -> ()),
            );
...
unsafe extern "C" fn luaH_request_get_finished(
    mut L: *mut lua_State,
...
pub unsafe extern "C" fn request_class_setup(mut L: *mut lua_State) {
    static mut request_methods: [luaL_Reg; 4] = unsafe {
        [
            {
                let mut init = luaL_Reg {
                    name: b"add_signal\0" as *const u8 as *const std::ffi::c_char,
                    func: Some(
                        luaH_request_class_add_signal
            ...
            },
            {
                let mut init = luaL_Reg {
                    ...
                    func: Some(
                        luaH_request_class_remove_signal
                            as unsafe extern "C" fn(*mut lua_State) -> gint,
                    ),
                };
                init
            },
            {
                let mut init = luaL_Reg {
                    ...
                    func: Some(
                        luaH_request_class_emit_signal
                            as unsafe extern "C" fn(*mut lua_State) -> gint,
                    ),
                };
                init
    ...
    static mut request_meta: [luaL_Reg; 9] = unsafe {
        [
            {
                let mut init = luaL_Reg {
    ...
    luaH_class_setup(
        ...
        ::core::mem::transmute::<
            Option::<unsafe extern "C" fn(*mut lua_State) -> *mut request_t>,
            lua_class_allocator_t,
        >(Some(request_new as unsafe extern "C" fn(*mut lua_State) -> *mut request_t)),
        None,
        None,
    ...
    luaH_class_add_property(
        ...
        ::core::mem::transmute::<
            Option::<
                unsafe extern "C" fn(*mut lua_State, *mut request_t) -> std::ffi::c_int,
            >,

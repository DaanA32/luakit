...
#[c2rust::header_src = "/usr/include/glib-2.0/gio/gapplication.h:20"]
...
#[c2rust::header_src = "/usr/include/glib-2.0/gio/giotypes.h:20"]
pub mod giotypes_h {
    #[c2rust::src_loc = "59:1"]
    pub type GApplication = _GApplication;
    use super::gapplication_h::_GApplication;
}
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkapplication.h:20"]
...
#[c2rust::header_src = "/home/daana/git/luakit/globalconf.h:20"]
...
#[c2rust::header_src = "/usr/include/webkitgtk-4.1/webkit/WebKitUserContent.h:21"]
...
#[c2rust::header_src = "/home/daana/git/luakit/clib/stylesheet.h:21"]
...
#[c2rust::header_src = "/home/daana/git/luakit/clib/luakit.h:19"]
pub mod luakit_h {
    use super::lua_h::lua_State;
...
pub use self::lua_h::{
    lua_CFunction, LUA_MULTRET, lua_State, lua_gettop, lua_pushvalue, lua_pushstring,
    lua_createtable, lua_newuserdata, lua_setmetatable, lua_setfenv,
};

...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkcontainer.h:19"]
...
#[c2rust::header_src = "/usr/include/webkitgtk-4.1/webkit/WebKitWebView.h:19"]
...
#[c2rust::header_src = "/usr/include/webkitgtk-4.1/webkit/WebKitWebViewBase.h:19"]
...
#[c2rust::header_src = "/usr/include/webkitgtk-4.1/webkit/WebKitDownload.h:19"]
...
#[c2rust::header_src = "/home/daana/git/luakit/common/tokenize.h:20"]
pub mod tokenize_h {
    #[c2rust::src_loc = "7:9"]
...
#[c2rust::header_src = "/usr/include/luajit-2.1/lua.h:20"]
pub mod lua_h {
...
#[c2rust::header_src = "/home/daana/git/luakit/common/signal.h:20"]
pub mod signal_h {
    #[c2rust::src_loc = "29:1"]
...
pub mod ipc_h {
    ...
    extern "C" {
        ...
        pub fn ipc_endpoints_get() -> *const GPtrArray;
...
#[c2rust::header_src = "/home/daana/git/luakit/common/clib/ipc.h:25"]
pub mod clib_ipc_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
...
#[c2rust::header_src = "/home/daana/git/luakit/common/luaobject.h:20"]
pub mod luaobject_h {
    use super::lua_h::lua_State;
    use super::gtypes_h::{gint, gchar};
    extern "C" {
...
#[c2rust::header_src = "/home/daana/git/luakit/widgets/webview.h:22"]
pub mod webview_h {
    use super::lua_h::lua_State;
    use super::gtypes_h::gint;
    ...
    extern "C" {
        #[c2rust::src_loc = "28:1"]
        pub fn luaH_checkwebview(L: *mut lua_State, udx: gint) -> *mut widget_t;
        #[c2rust::src_loc = "29:1"]
        pub fn webview_get_by_id(view_id: guint64) -> *mut widget_t;
        #[c2rust::src_loc = "32:1"]
        pub fn webview_get_endpoint(w: *mut widget_t) -> *mut ipc_endpoint_t;
    }
}
...
#[c2rust::header_src = "/home/daana/git/luakit/common/luaserialize.h:26"]
...
pub use self::WebKitWebView_h::{
    _WebKitWebView, WebKitWebViewPrivate, _WebKitWebViewPrivate,
    webkit_web_view_get_type, webkit_web_view_get_page_id,
};
pub use self::WebKitWebViewBase_h::{
    WebKitWebViewBase, _WebKitWebViewBase, WebKitWebViewBasePrivate,
    _WebKitWebViewBasePrivate,
};
pub use self::WebKitDownload_h::WebKitWebView;
...
pub use self::lua_h::{
    lua_Integer, lua_State, lua_gettop, lua_settop, lua_remove, lua_insert, lua_isnumber,
    lua_isuserdata, lua_type, lua_tointeger, lua_tolstring, lua_pushinteger,
    lua_pushstring,
};
...
pub use self::ipc_h::{
    ...
    IPC_ENDPOINT_DISCONNECTED, _ipc_endpoint_t, ipc_endpoint_t, ipc_endpoints_get,
    ipc_send_lua,
};
...
use self::webview_h::{luaH_checkwebview, webview_get_by_id, webview_get_endpoint};
use self::luauniq_h::luaH_uniq_get;
...
pub unsafe extern "C" fn ipc_channel_send(mut L: *mut lua_State) -> gint {
    ...
    if lua_isuserdata(L, 2 as std::ffi::c_int) != 0 {
        ...
        page_id = webkit_web_view_get_page_id(
            g_type_check_instance_cast(
    ...
    if !ipc.is_null() {
        ipc_send_lua(ipc, IPC_TYPE_lua_ipc, L, 2 as std::ffi::c_int, lua_gettop(L));
    } else {
        ...
        while i < (*endpoints).len {
            let mut ipc_0: *mut ipc_endpoint_t = *((*endpoints).pdata).offset(i as isize)

...
pub mod gtree_h {
    ...
    use super::gtypes_h::{
        GCompareDataFunc, gpointer, GDestroyNotify, gconstpointer, gboolean,
    };
    extern "C" {
        #[c2rust::src_loc = "40:16"]
        pub type _GTree;
...
pub mod signal_h {
    ...
    use super::gtree_h::{
        GTree, g_tree_new_full, g_tree_lookup, g_tree_insert, g_tree_remove,
    };
    use super::garray_h::{
...
pub use self::gtree_h::{
    GTree, _GTree, g_tree_new_full, g_tree_insert, g_tree_remove, g_tree_lookup,
};
pub use self::lua_h::{
    lua_CFunction, lua_State, lua_gettop, lua_settop, lua_pushvalue, lua_remove,
    lua_isstring, lua_type, lua_typename, lua_rawequal, lua_tolstring, lua_touserdata,
    lua_topointer, lua_pushnil, lua_pushlstring, lua_pushlightuserdata, lua_rawget,
    lua_createtable, lua_getmetatable, lua_setfield, lua_rawset, lua_setmetatable,
    lua_next,
};
pub use self::log_h::{
...
pub use self::lauxlib_h::{
    luaL_Reg, luaL_register, luaL_typerror, luaL_checklstring, luaL_newmetatable,
};
...
unsafe extern "C" fn luaH_class_property_get(
    ...
    let mut attr: *const gchar = luaL_checklstring(L, fieldidx, 0 as *mut size_t);

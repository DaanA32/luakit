...
#[c2rust::header_src = "/usr/include/glib-2.0/glib/gregex.h:22"]
pub mod gregex_h {
...
pub use self::lua_h::{
    lua_CFunction, lua_State, lua_gettop, lua_pushvalue, lua_tolstring, lua_touserdata,
    lua_pushstring, lua_pushboolean, lua_createtable, lua_newuserdata, lua_setmetatable,
    lua_setfenv,
};
...
pub use self::gtypes_h::{
    gint, gchar, gpointer, gboolean, GDestroyNotify, guint, GCompareDataFunc,
    gconstpointer,
};
...
#[inline]
#[c2rust::src_loc = "36:1"]
unsafe extern "C" fn luaH_regex_class_remove_signal(mut L: *mut lua_State) -> gint {
...
#[inline]
#[c2rust::src_loc = "36:1"]
unsafe extern "C" fn regex_new(mut L: *mut lua_State) -> *mut lregex_t {
    let mut p: *mut lregex_t = lua_newuserdata(
        L,
        ::core::mem::size_of::<lregex_t>() as std::ffi::c_ulong,
    ) as *mut lregex_t;
    memset(
...
#[inline]
#[c2rust::src_loc = "36:1"]
unsafe extern "C" fn luaH_regex_class_add_signal(mut L: *mut lua_State) -> gint {
...
#[inline]
#[c2rust::src_loc = "36:1"]
unsafe extern "C" fn luaH_regex_class_emit_signal(mut L: *mut lua_State) -> gint {
...
#[c2rust::src_loc = "42:1"]
unsafe extern "C" fn luaH_regex_gc(mut L: *mut lua_State) -> gint {
...
#[c2rust::src_loc = "52:1"]
unsafe extern "C" fn luaH_regenerate_regex(
    mut L: *mut lua_State,
...
#[c2rust::src_loc = "70:1"]
unsafe extern "C" fn luaH_regex_new(mut L: *mut lua_State) -> std::ffi::c_int {
...
#[c2rust::src_loc = "82:1"]
unsafe extern "C" fn luaH_regex_match(mut L: *mut lua_State) -> std::ffi::c_int {
    let mut regex: *mut lregex_t = luaH_checkudata(
        L,
        1 as std::ffi::c_int,
        &mut regex_class,
...
#[c2rust::src_loc = "94:1"]
unsafe extern "C" fn luaH_regex_get_pattern(
    mut L: *mut lua_State,
    mut regex: *mut lregex_t,
) -> std::ffi::c_int {
...
unsafe extern "C" fn luaH_regex_set_pattern(
    mut L: *mut lua_State,
    mut regex: *mut lregex_t,
) -> std::ffi::c_int {
    let mut new_pattern: *mut gchar = g_strdup_inline(
        luaL_checklstring(L, -(1 as std::ffi::c_int), 0 as *mut size_t),
    );
    g_free((*regex).pattern as gpointer);
...
pub unsafe extern "C" fn regex_class_setup(mut L: *mut lua_State) {
    static mut regex_methods: [luaL_Reg; 5] = unsafe {
        [
            {
    ...
    static mut regex_meta: [luaL_Reg; 10] = unsafe {
        [
            {
                let mut init = luaL_Reg {
            ...
            },
            {
                let mut init = luaL_Reg {
                    ...
                    func: Some(
                        luaH_regex_gc as unsafe extern "C" fn(*mut lua_State) -> gint,
                    ),
                };
                init
            },
    ...
    luaH_class_setup(
        ...
        ::core::mem::transmute::<
            Option::<unsafe extern "C" fn(*mut lua_State) -> *mut lregex_t>,
            lua_class_allocator_t,
        >(Some(regex_new as unsafe extern "C" fn(*mut lua_State) -> *mut lregex_t)),
        None,
        None,
    ...
    luaH_class_add_property(
        ...
        ::core::mem::transmute::<
            Option::<
                unsafe extern "C" fn(*mut lua_State, *mut lregex_t) -> std::ffi::c_int,
            >,

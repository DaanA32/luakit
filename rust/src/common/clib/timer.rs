...
unsafe extern "C-unwind" fn luaH_timer_destroy(
    mut L: *mut lua_State,
...
pub unsafe extern "C-unwind" fn timer_class_setup(mut L: *mut lua_State) {
    ...
    luaH_class_setup(
        ...
        >(Some(timer_new as unsafe extern "C-unwind" fn(*mut lua_State) -> *mut ltimer_t)),
        Some(
    ...
    luaH_class_add_property(
        ...
        ::core::mem::transmute::<
            Option::<
                unsafe extern "C-unwind" fn(*mut lua_State, *mut ltimer_t) -> std::ffi::c_int,
            >,

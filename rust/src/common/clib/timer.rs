...
#[c2rust::header_src = "/usr/include/glib-2.0/glib/gtree.h:23"]
pub mod gtree_h {
    #[c2rust::src_loc = "40:1"]
...
#[c2rust::header_src = "/usr/include/glib-2.0/glib/ghash.h:23"]
pub mod ghash_h {
    #[c2rust::src_loc = "40:1"]
...
#[c2rust::header_src = "/usr/include/glib-2.0/glib/gmain.h:23"]
pub mod gmain_h {
    #[c2rust::src_loc = "86:1"]
...
#[c2rust::header_src = "/usr/include/glib-2.0/glib/gslist.h:23"]
pub mod gslist_h {
    #[c2rust::src_loc = "39:1"]
...
pub mod luah_h {
    ...
    use super::lua_h::{lua_State, lua_gettop, lua_Debug, lua_getstack, lua_getinfo};
...
pub use self::lua_h::{
    lua_CFunction, lua_Integer, lua_Debug, lua_State, lua_gettop, lua_settop,
    lua_pushvalue, lua_remove, lua_tolstring, lua_pushinteger, lua_pushlstring,
    lua_pushboolean, lua_pushlightuserdata, lua_rawget, lua_createtable, lua_newuserdata,
    lua_setmetatable, lua_setfenv, lua_getstack, lua_getinfo,
};
pub use self::luaclass_h::{
    lua_class_propfunc_t, lua_object_t, lua_class_t, lua_class_property_array_t,
...
pub use self::gtypes_h::{
    gint, gpointer, gchar, guint, gboolean, GDestroyNotify, GCompareDataFunc,
    gconstpointer,
};
...
pub use self::lauxlib_h::{luaL_Reg, luaL_checklstring, luaL_checkinteger, luaL_error};
pub use self::gmain_h::{
    GSource, _GSource, GSourcePrivate, GMainContext, GSourceFuncs, _GSourceFuncs,
    ...
    _GSourceCallbackFuncs, _GSourcePrivate, _GMainContext,
    g_main_context_find_source_by_id, g_source_destroy, g_timeout_add,
};
pub use self::gslist_h::{GSList, _GSList};
pub use self::log_h::{
    log_level_t, LOG_LEVEL_debug, LOG_LEVEL_verbose, LOG_LEVEL_info, LOG_LEVEL_warn,
    LOG_LEVEL_error, LOG_LEVEL_fatal, va_log,
};
pub use self::glibconfig_h::{guint64, gint64};
...
#[inline]
#[c2rust::src_loc = "36:1"]
unsafe extern "C" fn timer_new(mut L: *mut lua_State) -> *mut ltimer_t {
    let mut p: *mut ltimer_t = lua_newuserdata(
        L,
        ::core::mem::size_of::<ltimer_t>() as std::ffi::c_ulong,
    ) as *mut ltimer_t;
    memset(
...
#[inline]
#[c2rust::src_loc = "36:1"]
unsafe extern "C" fn luaH_timer_class_emit_signal(mut L: *mut lua_State) -> gint {
...
#[inline]
#[c2rust::src_loc = "36:1"]
unsafe extern "C" fn luaH_timer_class_remove_signal(mut L: *mut lua_State) -> gint {
...
#[inline]
#[c2rust::src_loc = "36:1"]
unsafe extern "C" fn luaH_timer_class_add_signal(mut L: *mut lua_State) -> gint {
...
#[c2rust::src_loc = "42:1"]
unsafe extern "C" fn luaH_timer_destroy(
    mut L: *mut lua_State,
    mut timer: *mut ltimer_t,
) {
    let mut source: *mut GSource = g_main_context_find_source_by_id(
...
#[c2rust::src_loc = "65:1"]
unsafe extern "C" fn luaH_timer_new(mut L: *mut lua_State) -> std::ffi::c_int {
    luaH_class_new(L, &mut timer_class);
    let mut timer: *mut ltimer_t = luaH_checkudata(
        L,
        -(1 as std::ffi::c_int),
        &mut timer_class,
    ) as *mut ltimer_t;
...
#[c2rust::src_loc = "74:1"]
unsafe extern "C" fn luaH_timer_start(mut L: *mut lua_State) -> std::ffi::c_int {
    let mut timer: *mut ltimer_t = luaH_checkudata(
        L,
        1 as std::ffi::c_int,
        &mut timer_class,
    ...
    if (*timer).interval == 0 {
        luaL_error(L, b"interval not set\0" as *const u8 as *const std::ffi::c_char);
    }
    if (*timer).id == -(1 as std::ffi::c_int) {
        ...
        (*timer)
            ...
            Some(timer_handle_timeout as unsafe extern "C" fn(gpointer) -> gboolean),
            timer as gpointer,
        ) as std::ffi::c_int;
    } else {
        luaH_warn(L, b"timer already started\0" as *const u8 as *const std::ffi::c_char);
    }
    return 0 as std::ffi::c_int;
}
#[c2rust::src_loc = "90:1"]
unsafe extern "C" fn luaH_timer_stop(mut L: *mut lua_State) -> std::ffi::c_int {
    let mut timer: *mut ltimer_t = luaH_checkudata(
        L,
        1 as std::ffi::c_int,
        &mut timer_class,
    ...
    if (*timer).id == -(1 as std::ffi::c_int) {
        luaH_warn(L, b"timer already stopped\0" as *const u8 as *const std::ffi::c_char);
    } else {
...
unsafe extern "C" fn luaH_timer_set_interval(
    mut L: *mut lua_State,
    mut timer: *mut ltimer_t,
) -> std::ffi::c_int {
...
unsafe extern "C" fn luaH_timer_get_interval(
    mut L: *mut lua_State,
    mut timer: *mut ltimer_t,
) -> std::ffi::c_int {
...
unsafe extern "C" fn luaH_timer_get_started(
    mut L: *mut lua_State,
    mut timer: *mut ltimer_t,
) -> std::ffi::c_int {
    lua_pushboolean(L, ((*timer).id != -(1 as std::ffi::c_int)) as std::ffi::c_int);
    return 1 as std::ffi::c_int;
}
#[no_mangle]
#[c2rust::src_loc = "122:1"]
pub unsafe extern "C" fn luaH_timer_index_miss_property(
    mut L: *mut lua_State,
...
pub unsafe extern "C" fn luaH_timer_newindex_miss_property(
    mut L: *mut lua_State,
    mut UNUSED_obj: *mut lua_object_t,
) -> gint {
    return luaL_error(
...
pub unsafe extern "C" fn timer_class_setup(mut L: *mut lua_State) {
    static mut timer_methods: [luaL_Reg; 5] = unsafe {
        [
            {
                let mut init = luaL_Reg {
                    name: b"add_signal\0" as *const u8 as *const std::ffi::c_char,
                    func: Some(
                        luaH_timer_class_add_signal
            ...
            },
            {
                let mut init = luaL_Reg {
                    ...
                    func: Some(
                        luaH_timer_class_remove_signal
                            as unsafe extern "C" fn(*mut lua_State) -> gint,
                    ),
                };
                init
    ...
    static mut timer_meta: [luaL_Reg; 11] = unsafe {
        [
            {
                let mut init = luaL_Reg {
    ...
    luaH_class_setup(
        ...
        ::core::mem::transmute::<
            Option::<unsafe extern "C" fn(*mut lua_State) -> *mut ltimer_t>,
            lua_class_allocator_t,
        >(Some(timer_new as unsafe extern "C" fn(*mut lua_State) -> *mut ltimer_t)),
        Some(
            luaH_timer_index_miss_property
                as unsafe extern "C" fn(*mut lua_State, *mut lua_object_t) -> gint,
        ),
        Some(
    ...
    luaH_class_add_property(
        ...
        ::core::mem::transmute::<
            Option::<
                unsafe extern "C" fn(*mut lua_State, *mut ltimer_t) -> std::ffi::c_int,
            >,

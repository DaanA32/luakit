...
pub mod gtktypes_h {
    ...
    use super::gtkadjustment_h::_GtkAdjustment;
}
...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkadjustment.h:20"]
pub mod gtkadjustment_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "54:8"]
    pub struct _GtkAdjustment {
        pub parent_instance: GInitiallyUnowned,
        pub priv_0: *mut GtkAdjustmentPrivate,
    }
    #[c2rust::src_loc = "45:1"]
...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkbin.h:20"]
pub mod gtkbin_h {
    #[c2rust::src_loc = "45:1"]
...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkcontainer.h:20"]
...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkscrolledwindow.h:20"]
pub mod gtkscrolledwindow_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "49:8"]
    pub struct _GtkScrolledWindow {
        pub container: GtkBin,
        pub priv_0: *mut GtkScrolledWindowPrivate,
    }
    #[c2rust::src_loc = "46:1"]
    ...
    pub type GtkPolicyType = std::ffi::c_uint;
...
#[c2rust::header_src = "/home/daana/git/luakit/common/luah.h:19"]
pub mod luah_h {
    #[inline]
    #[c2rust::src_loc = "150:1"]
...
pub use self::lua_h::{
    lua_CFunction, lua_Number, LUA_TNIL, LUA_TTABLE, lua_State, lua_gettop, lua_settop,
    lua_type, lua_tonumber, lua_tolstring, lua_pushnumber, lua_pushlstring,
    lua_pushstring, lua_pushcclosure, lua_rawget, lua_createtable, lua_rawset,
};
...
pub use self::gtktypes_h::{GtkWidget, GtkAdjustment};
pub use self::gtkwidget_h::{
    _GtkWidget, GtkWidgetPrivate, _GtkWidgetPrivate, gtk_widget_show,
};
...
pub use self::gtkadjustment_h::{
    _GtkAdjustment, GtkAdjustmentPrivate, _GtkAdjustmentPrivate,
    gtk_adjustment_get_value, gtk_adjustment_set_value, gtk_adjustment_get_upper,
};
...
pub use self::gtkscrolledwindow_h::{
    _GtkScrolledWindow, GtkScrolledWindowPrivate, GtkScrolledWindow, GtkPolicyType,
    GTK_POLICY_EXTERNAL, GTK_POLICY_NEVER, GTK_POLICY_AUTOMATIC, GTK_POLICY_ALWAYS,
    _GtkScrolledWindowPrivate, gtk_scrolled_window_get_type, gtk_scrolled_window_new,
    gtk_scrolled_window_get_hadjustment, gtk_scrolled_window_get_vadjustment,
...
use self::common_h::{
    focus_cb, luaH_widget_destroy, luaH_widget_focus, luaH_widget_get_child,
    luaH_widget_get_children, luaH_widget_hide, luaH_widget_remove,
    luaH_widget_set_child, luaH_widget_show, luaH_widget_replace, luaH_widget_send_key,
...
pub unsafe extern "C" fn luaH_widget_set_scrollbars(
    ...
    ) != 0
    {
        ...
        ) != 0
        {
            luaL_error(
                L,
                b"Bad horizontal scrollbar policy\0" as *const u8
    ...
    ) != 0
    {
        ...
        ) != 0
        {
            luaL_error(
                L,
                b"Bad vertical scrollbar policy\0" as *const u8
                    as *const std::ffi::c_char,
            );
        }
    }
...
pub unsafe extern "C" fn luaH_scrolled_get_scroll(
    ...
    let mut horz = gtk_scrolled_window_get_hadjustment(
        g_type_check_instance_cast(
            (*w).widget as *mut GTypeInstance,
            gtk_scrolled_window_get_type(),
        ) as *mut std::ffi::c_void as *mut GtkScrolledWindow,
    );
    let mut vert = gtk_scrolled_window_get_vadjustment(
        g_type_check_instance_cast(
            (*w).widget as *mut GTypeInstance,
            gtk_scrolled_window_get_type(),
        ) as *mut std::ffi::c_void as *mut GtkScrolledWindow,

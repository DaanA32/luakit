...
pub mod gdkevents_h {
    ...
    use super::gdktypes_h::{GdkWindow, GdkDevice};
    use super::glibconfig_h::{gint8, guint32, gint16};
    use super::gtypes_h::{gdouble, guint, gboolean};
}
...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkeventbox.h:22"]
...
pub mod common_h {
    use super::gtktypes_h::GtkWidget;
    use super::gdkevents_h::{
        GdkEventButton, GdkEventScroll, GdkEventCrossing, GdkEventFocus,
    };
    ...
    extern "C" {
        ...
        pub fn button_cb(
            _: *mut GtkWidget,
            _: *mut GdkEventButton,
            _: *mut widget_t,
        ) -> gboolean;
        #[c2rust::src_loc = "100:1"]
        pub fn scroll_cb(
            _: *mut GtkWidget,
            _: *mut GdkEventScroll,
            _: *mut widget_t,
        ) -> gboolean;
        #[c2rust::src_loc = "101:1"]
        pub fn mouse_cb(
            _: *mut GtkWidget,
            _: *mut GdkEventCrossing,
            _: *mut widget_t,
        ) -> gboolean;
...
pub use self::lua_h::{lua_CFunction, lua_State, lua_pushstring, lua_pushcclosure};
...
pub use self::gdktypes_h::{
    GdkRectangle, GdkRGBA, GdkDevice, GdkWindow, _GdkDevice, _GdkWindow,
};
...
pub use self::gdkevents_h::{
    ...
    GDK_EXPOSE, GDK_DESTROY, GDK_DELETE, GDK_NOTHING, _GdkEventButton, GdkEventButton,
    _GdkEventScroll, GdkScrollDirection, GDK_SCROLL_SMOOTH, GDK_SCROLL_RIGHT,
    GDK_SCROLL_LEFT, GDK_SCROLL_DOWN, GDK_SCROLL_UP, GdkEventScroll, _GdkEventFocus,
    GdkEventFocus, _GdkEventCrossing, GdkNotifyType, GDK_NOTIFY_UNKNOWN,
    GDK_NOTIFY_NONLINEAR_VIRTUAL, GDK_NOTIFY_NONLINEAR, GDK_NOTIFY_INFERIOR,
    GDK_NOTIFY_VIRTUAL, GDK_NOTIFY_ANCESTOR, GdkCrossingMode, GDK_CROSSING_DEVICE_SWITCH,
    GDK_CROSSING_TOUCH_END, GDK_CROSSING_TOUCH_BEGIN, GDK_CROSSING_STATE_CHANGED,
    GDK_CROSSING_GTK_UNGRAB, GDK_CROSSING_GTK_GRAB, GDK_CROSSING_UNGRAB,
    GDK_CROSSING_GRAB, GDK_CROSSING_NORMAL, GdkEventCrossing,
};
...
use self::lauxlib_h::{luaL_argerror, luaL_checklstring};
use self::luaobject_h::luaH_object_property_signal;
use self::gtkeventbox_h::gtk_event_box_new;
use self::common_h::{
    button_cb, scroll_cb, mouse_cb, focus_cb, luaH_widget_destroy, luaH_widget_focus,

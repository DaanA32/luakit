...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkbox.h:22"]
pub mod gtkbox_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "51:8"]
    ...
    extern "C" {
        ...
        #[c2rust::src_loc = "96:1"]
        pub fn gtk_box_set_homogeneous(box_0: *mut GtkBox, homogeneous: gboolean);
        #[c2rust::src_loc = "99:1"]
        pub fn gtk_box_get_homogeneous(box_0: *mut GtkBox) -> gboolean;
        #[c2rust::src_loc = "101:1"]
        pub fn gtk_box_set_spacing(box_0: *mut GtkBox, spacing: gint);
        #[c2rust::src_loc = "104:1"]
        pub fn gtk_box_get_spacing(box_0: *mut GtkBox) -> gint;
        #[c2rust::src_loc = "112:1"]
        pub fn gtk_box_reorder_child(
            box_0: *mut GtkBox,
            child: *mut GtkWidget,
            position: gint,
        );
...
pub use self::lua_h::{
    lua_CFunction, lua_Number, LUA_TNIL, LUA_TBOOLEAN, LUA_TTABLE, lua_State, lua_gettop,
    lua_settop, lua_type, lua_tonumber, lua_toboolean, lua_tolstring, lua_pushnumber,
    lua_pushstring, lua_pushcclosure, lua_pushboolean, lua_rawget,
};
...
pub use self::gtkbox_h::{
    _GtkBox, GtkBoxPrivate, GtkBox, _GtkBoxPrivate, gtk_box_get_type, gtk_box_new,
    gtk_box_pack_start, gtk_box_pack_end, gtk_box_set_homogeneous,
    gtk_box_get_homogeneous, gtk_box_set_spacing, gtk_box_get_spacing,

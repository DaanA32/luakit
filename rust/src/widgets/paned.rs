...
unsafe extern "C-unwind" fn luaH_paned_pack(mut L: *mut lua_State) -> gint {
...
unsafe extern "C-unwind" fn luaH_paned_get_child(
    mut L: *mut lua_State,
    mut w: *mut widget_t,
    mut n: gint,
) -> gint {
    let mut widget = std::ptr::null_mut();
...
unsafe extern "C-unwind" fn luaH_paned_get_position(
    mut L: *mut lua_State,
    mut w: *mut widget_t,
) -> gint {
...
unsafe extern "C-unwind" fn luaH_paned_set_position(
    mut L: *mut lua_State,
    mut w: *mut widget_t,
) -> gint {
...
unsafe extern "C" fn luaH_paned_index(
    ...
    match token as std::ffi::c_uint {
        ...
        160 | 161 => {
            ...
            lua_pushcclosure(L, luaH_paned_pack, 1 as std::ffi::c_int);
            return 1 as std::ffi::c_int;
        }
...
pub unsafe extern "C" fn widget_paned(
    ...
    (*w).index = Some(luaH_paned_index);
    (*w).newindex = Some(luaH_paned_newindex);

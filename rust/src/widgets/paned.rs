...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkenums.h:22"]
pub mod gtkenums_h {
    #[c2rust::src_loc = "341:9"]
    pub type GtkOrientation = std::ffi::c_uint;
    #[c2rust::src_loc = "344:3"]
    pub const GTK_ORIENTATION_VERTICAL: GtkOrientation = 1;
    #[c2rust::src_loc = "343:3"]
    pub const GTK_ORIENTATION_HORIZONTAL: GtkOrientation = 0;
}
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkcontainer.h:22"]
...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkpaned.h:22"]
pub mod gtkpaned_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "48:8"]
    ...
    use super::gtype_h::GType;
    use super::gtkenums_h::{GtkOrientation, GTK_ORIENTATION_HORIZONTAL};
    use super::gtktypes_h::GtkWidget;
...
pub use self::lua_h::{
    lua_CFunction, lua_Number, LUA_REGISTRYINDEX, LUA_GLOBALSINDEX, LUA_TNIL, LUA_TTABLE,
    lua_State, lua_gettop, lua_settop, lua_remove, lua_type, lua_tonumber, lua_toboolean,
    lua_pushnumber, lua_pushlstring, lua_pushstring, lua_pushcclosure,
...
pub use self::gtkenums_h::{
    GtkOrientation, GTK_ORIENTATION_VERTICAL, GTK_ORIENTATION_HORIZONTAL,
};
pub use self::gtkcontainer_h::{
    GtkContainer, _GtkContainer, GtkContainerPrivate, _GtkContainerPrivate,
};
pub use self::gtkpaned_h::{
    _GtkPaned, GtkPanedPrivate, GtkPaned, _GtkPanedPrivate, gtk_paned_get_type,
    gtk_paned_new, gtk_paned_pack1, gtk_paned_pack2, gtk_paned_get_position,
    gtk_paned_set_position, gtk_paned_get_child1, gtk_paned_get_child2,
};
...
pub use self::luaobject_h::{
    luaH_object_registry_push, luaH_object_push, luaH_object_property_signal,
};
pub use self::luah_h::luaH_rawfield;
use self::common_h::{
    focus_cb, luaH_widget_destroy, luaH_widget_focus, luaH_widget_get_children,
    luaH_widget_hide, luaH_widget_remove, luaH_widget_show, luaH_widget_replace,
    ...
    luaH_widget_get_align, add_cb, parent_set_cb, resize_cb, destroy_cb,
};
pub use self::gmacros_h::{FALSE, TRUE};
pub use self::__stddef_null_h::NULL;
#[c2rust::src_loc = "24:1"]
unsafe extern "C" fn luaH_paned_pack(mut L: *mut lua_State) -> gint {
    ...
    if top > 2 as std::ffi::c_int && !(lua_type(L, 3 as std::ffi::c_int) == LUA_TNIL) {
        ...
        {
            resize = if lua_toboolean(L, -(1 as std::ffi::c_int)) != 0 {
                TRUE
            } else {
                FALSE
            };
        ...
        {
            shrink = if lua_toboolean(L, -(1 as std::ffi::c_int)) != 0 {
                TRUE
            } else {
                FALSE
            };
    ...
    let mut t = lua_tonumber(L, LUA_GLOBALSINDEX - 1 as std::ffi::c_int)
        as luakit_token_t;
    if t as std::ffi::c_uint == L_TK_PACK1 as std::ffi::c_int as std::ffi::c_uint {
        gtk_paned_pack1(
            g_type_check_instance_cast(
                (*w).widget as *mut GTypeInstance,
                gtk_paned_get_type(),
            ) as *mut std::ffi::c_void as *mut GtkPaned,
            g_type_check_instance_cast(
...
#[c2rust::src_loc = "52:1"]
unsafe extern "C" fn luaH_paned_get_child(
    mut L: *mut lua_State,
    mut w: *mut widget_t,
    mut n: gint,
) -> gint {
    let mut widget = NULL as *mut GtkWidget;
    if n == 1 as std::ffi::c_int {
        widget = gtk_paned_get_child1(
            g_type_check_instance_cast(
                (*w).widget as *mut GTypeInstance,
                gtk_paned_get_type(),
            ) as *mut std::ffi::c_void as *mut GtkPaned,
...
#[c2rust::src_loc = "69:1"]
unsafe extern "C" fn luaH_paned_get_position(
    mut L: *mut lua_State,
    mut w: *mut widget_t,
) -> gint {
    let mut position = gtk_paned_get_position(
        g_type_check_instance_cast(
            (*w).widget as *mut GTypeInstance,
            gtk_paned_get_type(),
        ) as *mut std::ffi::c_void as *mut GtkPaned,
    );
    lua_pushnumber(L, position as lua_Number);
    return 1 as std::ffi::c_int;
}
#[c2rust::src_loc = "77:1"]
unsafe extern "C" fn luaH_paned_set_position(
    mut L: *mut lua_State,
    mut w: *mut widget_t,
) -> gint {
    let mut position = lua_tonumber(L, -(1 as std::ffi::c_int)) as gint;
...
#[c2rust::src_loc = "85:1"]
unsafe extern "C" fn luaH_paned_index(
    mut L: *mut lua_State,
    mut w: *mut widget_t,
    ...
    match token as std::ffi::c_uint {
        ...
        160 | 161 => {
            lua_pushnumber(L, token as gint as lua_Number);
            lua_pushcclosure(
                L,
                Some(luaH_paned_pack as unsafe extern "C" fn(*mut lua_State) -> gint),
                1 as std::ffi::c_int,
            );
            return 1 as std::ffi::c_int;
        }
        242 | 136 => return luaH_paned_get_child(L, w, 1 as std::ffi::c_int),
        15 | 185 => return luaH_paned_get_child(L, w, 2 as std::ffi::c_int),
        167 => return luaH_paned_get_position(L, w),
        _ => {}
    }
    return 0 as std::ffi::c_int;
}
#[c2rust::src_loc = "116:1"]
unsafe extern "C" fn luaH_paned_newindex(
    mut L: *mut lua_State,
    mut w: *mut widget_t,
    mut token: luakit_token_t,
) -> gint {
...
#[no_mangle]
#[c2rust::src_loc = "133:1"]
pub unsafe extern "C" fn widget_paned(
    ...
    (*w)
        .widget = if token as std::ffi::c_uint
        == L_TK_VPANED as std::ffi::c_int as std::ffi::c_uint
    {

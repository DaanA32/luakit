...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkenums.h:20"]
pub mod gtkenums_h {
    #[c2rust::src_loc = "73:9"]
...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtkoverlay.h:20"]
pub mod gtkoverlay_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "43:8"]
    pub struct _GtkOverlay {
        pub parent: GtkBin,
        pub priv_0: *mut GtkOverlayPrivate,
    }
    #[c2rust::src_loc = "41:1"]
...
pub use self::lua_h::{
    ...
    lua_type, lua_tolstring, lua_pushstring, lua_pushcclosure, lua_rawget,
};
...
pub use self::gtkoverlay_h::{
    _GtkOverlay, GtkOverlayPrivate, GtkOverlay, _GtkOverlayPrivate, gtk_overlay_get_type,
    gtk_overlay_new, gtk_overlay_add_overlay, gtk_overlay_reorder_overlay,
};
pub use self::gmessages_h::G_LOG_DOMAIN;
use self::gtestutils_h::g_assertion_message_expr;
use self::lauxlib_h::{luaL_typerror, luaL_checknumber, luaL_error};

...
pub mod gobject_h {
    ...
    use super::gtype_h::{GTypeInstance, GValue};
...
#[c2rust::header_src = "/usr/include/pango-1.0/pango/pango-font.h:22"]
pub mod pango_font_h {
    #[c2rust::src_loc = "43:1"]
    ...
    extern "C" {
        ...
        pub fn pango_font_description_from_string(
            str: *const std::ffi::c_char,
        ) -> *mut PangoFontDescription;
    }
}
#[c2rust::header_src = "/usr/include/pango-1.0/pango/pango-layout.h:22"]
...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/deprecated/gtkmisc.h:22"]
pub mod gtkmisc_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "50:8"]
...
#[c2rust::header_src = "/usr/include/gtk-3.0/gtk/gtklabel.h:22"]
pub mod gtklabel_h {
    #[derive(Copy, Clone)]
    #[repr(C)]
    #[c2rust::src_loc = "52:8"]
    ...
    use super::gtype_h::GType;
    use super::gtypes_h::{gchar, gboolean, gint, gfloat};
    use super::gtktypes_h::GtkWidget;
    ...
    extern "C" {
        ...
        #[c2rust::src_loc = "109:1"]
        pub fn gtk_label_set_markup(label: *mut GtkLabel, str: *const gchar);
        ...
        pub fn gtk_label_set_xalign(label: *mut GtkLabel, xalign: gfloat);
        #[c2rust::src_loc = "218:1"]
        pub fn gtk_label_get_xalign(label: *mut GtkLabel) -> gfloat;
        #[c2rust::src_loc = "221:1"]
        pub fn gtk_label_set_yalign(label: *mut GtkLabel, yalign: gfloat);
        #[c2rust::src_loc = "225:1"]
        pub fn gtk_label_get_yalign(label: *mut GtkLabel) -> gfloat;
    }
}
...
#[c2rust::header_src = "/usr/include/glib-2.0/gobject/gvaluetypes.h:21"]
...
pub mod luah_h {
    ...
    use super::lua_h::{
        ...
        lua_getstack, lua_getinfo, lua_pushstring, lua_rawget, LUA_TNIL, lua_settop,
    };
...
pub use self::glibconfig_h::{
    gint8, guint8, gint16, guint16, guint32, gint64, guint64, gsize,
};
...
pub use self::gtype_h::{
    ...
    G_TYPE_FUNDAMENTAL_SHIFT, G_TYPE_INT, g_type_check_instance_cast,
};
pub use self::gvalue_h::{_GValue, C2RustUnnamed, g_value_init};
pub use self::gclosure_h::GCallback;
pub use self::gobject_h::{
    _GObject, GObject, GInitiallyUnowned, g_object_connect, g_object_set_property,
    g_object_get_data, g_object_set_data_full,
};
pub use self::lua_h::{
    lua_CFunction, lua_Number, lua_Integer, lua_Debug, LUA_TNIL, LUA_TBOOLEAN,
    LUA_TTABLE, lua_State, lua_gettop, lua_settop, lua_type, lua_tonumber, lua_toboolean,
    lua_pushnumber, lua_pushinteger, lua_pushlstring, lua_pushstring, lua_pushcclosure,
    lua_pushboolean, lua_rawget, lua_rawset, lua_getstack, lua_getinfo,
};
pub use self::log_h::{
...
pub use self::gtkwidget_h::{
    ...
    gtk_widget_show, gtk_widget_set_halign, gtk_widget_set_valign,
};
pub use self::pango_font_h::{
    PangoFontDescription, _PangoFontDescription, pango_font_description_free,
...
pub use self::gtklabel_h::{
    ...
    gtk_label_new, gtk_label_get_label, gtk_label_set_markup, gtk_label_set_use_markup,
    gtk_label_set_ellipsize, gtk_label_set_width_chars, gtk_label_get_width_chars,
    gtk_label_set_selectable, gtk_label_get_selectable, gtk_label_set_xalign,
    gtk_label_get_xalign, gtk_label_set_yalign, gtk_label_get_yalign,
};
...
use self::lauxlib_h::{luaL_typerror, luaL_argerror, luaL_checklstring, luaL_checknumber};
use self::luaobject_h::luaH_object_property_signal;
pub use self::luah_h::{luaH_checkboolean, luaH_warn, luaH_rawfield};
use self::common_h::{
...
#[c2rust::src_loc = "49:1"]
unsafe extern "C" fn luaH_label_set_align(
    mut L: *mut lua_State,
    mut w: *mut widget_t,
) -> gint {

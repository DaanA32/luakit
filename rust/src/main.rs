...
use libc::{
    __errno_location, exit, fork, memset, pid_t, setlocale, setsid, strchr, strcmp, strlen,
};
use luakit::{
        ...
        let entries: [GOptionEntry; 10] = [
            ...
            },
            {
                let mut init = GOptionEntry {
                    ...
                    arg_data: &raw mut globalconf.confpath as *mut *mut gchar as gpointer,
            ...
            },
            {
                let mut init = GOptionEntry {
                    ...
                    flags: 0 as std::ffi::c_int,
                    arg: G_OPTION_ARG_NONE,
                    arg_data: &raw mut globalconf.nounique as *mut gboolean as gpointer,
